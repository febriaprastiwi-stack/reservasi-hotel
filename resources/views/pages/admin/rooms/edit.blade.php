                ...
                <form action="{{ route('rooms.update', $room->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nomor_kamar" value="{{ $room->nomor_kamar }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="jenis_kamar" value="{{ $room->jenis_kamar }}" 
                                   class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="fasilitas_kamar" rows="3" class="form-control">{{ $room->fasilitas_kamar }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="jumlah_kasur" value="{{ $room->jumlah_kasur }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="harga_per_malam" value="{{ $room->harga_per_malam }}" 
